  ...
  return (
    <div className='quizinfo'>
      <div className="top1">
        ...
        <Link to="/profile-teacher/quiz-teacher/quiz-info/quiz-overview" className='add-quiz'>
      ...
      <div className="quiz-answers">
        <div className="one-answer">
          ...
          <p className='whole-ans'>وسائل التواصل الاجتماعي ساعدت في تقوية اللغة العربية.</p>
        </div>
        ...
        <div className="one-answer">
          ...
          <p className='whole-ans correct-ans1'>وسائل التواصل الاجتماعي ساعدت في تقوية اللغة العربية.</p>
        </div>
      </div>
          ...
          {students.length === 0 ? (
            ...
            students.map((student, index) => (
              <div key={index} className="student-item">
                ...
                <p className='ans-st'>اللغة العربية لغة صعبة لا تواكب التطور الرقمي.</p>
              </div>
            ))
          )}
        </div>
